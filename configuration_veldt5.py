...
class VELDT5Config(PretrainedConfig):
    r"""
    ...
    ```"""
    model_type = "vision-encoder-language-decoder-t5"
    is_composition = True
    ...
    def from_encoder_decoder_configs(
        ...
        r"""
        Instantiate a [`VELDT5Config`] (or a derived class) from a pre-trained encoder model
        configuration and decoder model configuration.

        Returns:
            [`VELDT5Config`]: An instance of a configuration object
        """
