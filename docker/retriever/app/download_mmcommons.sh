DATA_DIR=data
mkdir ${DATA_DIR}
python google_drive_downloader.py https://drive.google.com/file/d/1q-7dn7yyQc6Q5ientagj_pTZT5MLhUB7/view?usp=sharing ${DATA_DIR}/mmcommons_filtered_OPQ64_256-IVF262144_HNSW32-PQ64.index
